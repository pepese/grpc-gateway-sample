...
/*
Package helloworld_v2 is a reverse proxy.
...
var (
	pattern_HelloService_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "helloworld", "sayhello", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)
